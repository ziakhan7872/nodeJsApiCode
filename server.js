...
db.serialize(function () {
  ...
  // db.run(
  //   "create table Students (student_id INTEGER PRIMARY KEY AUTOINCREMENT,RollNumber varchar,student_Name Varchar,age int,father_Name varhcar,address Varchar,phone_num varchar,date_Of_Admission varchar,img varchar)"
  // );
